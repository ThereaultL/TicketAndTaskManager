...
def get_tickets():
    """
    Jsonify the global variable tickets and returns it
    """
...
def create_ticket():
    """
    Creates a new ticket, setting its id, tittle, description, and status before
    appending the tickets to the end of the tickets list
    """
